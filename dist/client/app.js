...
const sessions = {
  morning: {
    name: "Morning Activation", short: "AM", meta: "Sun–Thu · Home · 7–10 min", icon: "sun", accent: "#c9ff3d",
    description: "Light mobility, activation, and trunk control at RPE 3. Never progress it or create fatigue before the 10:00 AM gym sessions. Kegels and hand-grip work are optional, separate add-ons and may be skipped.",
    exercises: [
      ex("Brisk Marching in Place", "2–3 min", "RPE 3", 0, "warm-up", "march", "Stand tall, arms relaxed at your sides.", "March in place, lifting knees toward hip height and swinging the arms naturally.", "Torso upright. Land softly on the balls of your feet.", "Leaning backward or stomping heavily."),
      ex("Cat-Cow", "1 × 6–8", "RPE 3", 0, "mobility", "catcow", "Hands and knees; wrists under shoulders, knees under hips.", "Inhale into Cow; exhale and round into Cat. One full cycle per breath.", "Move slowly with your breath.", "Forcing range or moving from the neck only."),
      ...
      ex("Glute Bridges", "1 × 10–15", "2 sec squeeze", 0, "activation", "floor", "Lie on your back, knees bent, feet flat and hip-width.", "Squeeze the glutes; lift until knees, hips, and shoulders align. Lower with control.", "Drive through heels and keep ribs down.", "Pushing through toes or overextending the low back."),
      ...
      ex("Pelvic Floor (Kegel)", "Optional · 2–3 days/week", "Full relaxation between contractions", 0, "pelvic health", "kegel", "Sit or lie in a comfortable position.", "Contract gently, then release fully and breathe normally.", "Use only when there is a clear reason.", "Clenching glutes, abs, or thighs. Stop for pelvic pain, urinary difficulty, numbness, or excessive tightness.", 1, true),
      ex("Hand Grip", "Optional · 1 × 10–15", "2 sec close / open", 0, "grip", "grip", "Hold a grip trainer or simply make a fist.", "Close fully, pause, then open fully.", "Keep this separate from the core routine.", "Jerky, rushed reps.", 1, true)
    ]
  },
  gym: {
    name: "Gym Session", short: "GYM", meta: "Sun / Tue / Thu · 10:00 AM · 45–50 min", icon: "dumbbell", accent: "#ff8b3d",
    description: "Full-body machines at RPE 7–8, leaving about 2–3 good reps in reserve. After the bike, add 1–2 progressively heavier warm-up sets before Leg Press and, when useful, the first upper-body movement. Rest about 90 seconds by default and up to 2 minutes when needed.",
    exercises: [
      ...
      ex("Leg Press", "3 × 10–12", "RPE 7–8", 90, "squat", "legpress", "Feet shoulder-width on the platform; back flat on the pad.", "Lower under control toward 90° at the knees, then press without hard lockout.", "Drive through the whole foot. Increase load only after all 3 sets reach 12 clean reps.", "Knees caving in or bouncing at the bottom.", 3),
      ex("Back Extension", "3 × 10–12", "RPE 7–8", 90, "hinge", "hinge", "Hips on the pad, feet secured, body straight.", "Lower under control, then raise to a straight line — stop at neutral.", "Hinge from the hips, not the low back. Hip Thrust machine is an approved swap.", "Rounding and snapping up, or hyperextending.", 3),
      ex("Chest Press", "3 × 10–12", "RPE 7–8", 90, "horizontal push", "chestpress", "Adjust the seat so handles line up with mid-chest.", "Press until arms extend without locking; return with control.", "Keep shoulder blades back and down.", "Shrugging or excessively flaring elbows.", 3),
      ex("Seated Cable Row", "3 × 10–12", "RPE 7–8", 90, "horizontal pull", "row", "Sit tall, feet supported, knees slightly bent.", "Pull the handle to your torso, squeeze the shoulder blades, then control the return.", "Keep the chest up.", "Rounding or using momentum to yank.", 3),
      ex("Lat Pulldown", "3 × 10–12", "RPE 7–8", 90, "vertical pull", "pulldown", "Grip wider than shoulders; secure thighs under the pad.", "Pull to the upper chest, squeeze the lats, then return with control.", "Lead with elbows and use only a slight backward lean.", "Pulling behind the neck or swinging.", 3),
      ex("Cooldown Stretches", "Optional · 20–30 sec / side", "4 gentle stretches", 0, "cooldown", "stretch", "Move to open floor or a stable post.", "Quad stretch · Hamstring/calf stretch · Doorway chest stretch · Overhead lat stretch.", "Use static stretching only if it feels good or serves a flexibility goal.", "Forcing range or turning a stretch into pain.", 4, true)
    ]
  },
  football: {
    name: "Football Warm-up & Cooldown", short: "FB", meta: "Wednesday · 7:30 PM · Before / after your game", icon: "flame", accent: "#ff5f6d",
    description: "A hard 10-minute warm-up ceiling before football, followed by an easy walking cooldown. Static stretching afterward is optional. Log the match separately with Apple Watch duration and Active Calories.",
    exercises: [
      ex("Football Warm-up Jog", "2 min", "General movement", 0, "warm-up", "walk", "Open space to jog, or the pitch itself.", "Jog at an easy, conversational pace.", "Let the body warm gradually before anything dynamic.", "Sprinting cold or skipping straight to hard running."),
      ex("Football Dynamic Stretches", "3 min", "Leg swings · Walking lunges · High knees · Butt kicks", 0, "dynamic", "march", "Open space on or beside the pitch.", "Move through leg swings, walking lunges, high knees, and butt kicks.", "Controlled range, not maximal stretch.", "Static holds here — save those for the optional cooldown stretch."),
      ex("Lateral Shuffles & Carioca", "2 min", "Activation", 0, "activation", "walk", "Open space on or beside the pitch.", "Alternate lateral shuffles and carioca crossover steps.", "Stay low and light on your feet.", "Standing too tall or crossing the feet stiffly."),
      ex("Football Build-up Strides", "3 min · 3–4 reps", "60% → 90% speed", 0, "build-up", "walk", "Open space, 30–40m.", "Use short accelerations building from about 60% to 90% of top speed.", "Build speed gradually across each stride.", "Going full speed cold — this is a build, not a sprint test."),
      ...
      ex("Football Static Stretches", "Optional · 30 sec / side", "Only if it feels good", 0, "cooldown", "stretch", "Open floor after the game.", "Stretch areas that feel useful without forcing range.", "This is optional; easy walking is the core cooldown.", "Bouncing or forcing range.", 1, true)
    ]
  },
  padel: {
    name: "Padel Warm-up & Cooldown", short: "PDL", meta: "Monday · 6:00 PM · Before / after your game", icon: "heartbeat", accent: "#ffb84d",
    description: "An 8-minute warm-up before padel, followed by an easy walking cooldown. Static stretching afterward is optional. Leave work early to make the 6:00 PM start and log the match separately.",
    exercises: [
      ex("Padel Warm-up Jog", "2 min", "General movement", 0, "warm-up", "walk", "On court, or open space nearby.", "Jog easily or move around the court.", "Easy, conversational effort.", "Standing still, then jumping straight into hard rallies."),
      ex("Padel Dynamic Stretches", "2 min", "Leg swings · Lunges · Arm circles", 0, "dynamic", "march", "Open space or the court.", "Use leg swings, lunges with torso rotation, and arm circles.", "Controlled range, not maximal stretch.", "Static holds here — save those for the optional cooldown stretch."),
      ex("Padel Shoulder Prep", "2 min", "Band or bodyweight rotations", 0, "activation", "stretch", "Standing, band optional.", "Move through controlled shoulder rotations in both directions.", "Keep the shoulder warm-up smooth and pain-free.", "Skipping this before overhead play."),
      ex("Padel Sport-Specific Warm-up", "2 min", "Lateral movement · split steps · shadow swings · light rally", 0, "sport-specific", "walk", "Racket in hand, on court.", "Use lateral movement and split steps, then shadow swings and light rallying.", "Build shot pace gradually.", "Going full power on the first rally."),
      ...
      ex("Padel Static Stretches", "Optional · 20–30 sec each", "Only if it feels good", 0, "cooldown", "stretch", "Open floor after the game.", "Stretch areas that feel useful without forcing range.", "This is optional; easy walking is the core cooldown.", "Bouncing or forcing range.", 1, true)
    ]
  },
  general: {
  ...
  bad: {
    name: "Low-Energy Reset", short: "MIN", meta: "Optional · Home · 3–5 min", icon: "↘", accent: "#d9b3ff",
    description: "An optional low-energy reset when a little movement would help. Missing it is not program failure, and it never overrides rest or pain signals.",
    exercises: [
      ex("Brisk Marching in Place", "2–3 min", "Easy", 0, "minimum", "march", "Stand tall and give yourself permission to keep this easy.", "March smoothly for two to three minutes.", "Finish feeling better than you started.", "Turning the reset into a test."),
      ex("Cat-Cow", "1 × 6–8", "Easy and controlled", 0, "mobility", "catcow", "Hands and knees; wrists under shoulders, knees under hips.", "Inhale into Cow; exhale and round into Cat.", "Move slowly with your breath.", "Forcing range or moving into pain.")
    ]
  },
  gymLite: {
    name: "Reduced Gym", short: "LITE", meta: "Bad day · Gym · 25–30 min", icon: "↘", accent: "#ffb27a",
    description: "The bad-week fallback: warm up, then keep only Leg Press, Chest Press, and Seated Cable Row. Use lower effort and do not force progression.",
    exercises: [
...
function ex(name, prescription, intensity, rest, category, motion, setup, execution, cues, avoid, sets = 1, optional = false) {
  return { name, prescription, intensity, rest, category, motion, setup, execution, cues, avoid, sets, optional };
}
...
function renderHome() {
  ...
  app.innerHTML = REP_SAFE_DOM.sanitize(`
    ...
    <section class="weekly">
      <div class="section-title"><h2>${u.weekly}</h2><span>${"AM + main training"}</span></div>
...
function renderRecovery() {
  ...
  app.innerHTML = REP_SAFE_DOM.sanitize(`<section class="recovery-head"><p class="eyebrow">Recovery system</p><h1>Adaptation happens here.</h1><p>Use the basics daily. Check in weekly. Pain is information, not a challenge.</p></section>${recoveryDecisionCard()}
    <section class="recovery-grid">
      ...
      <article class="recovery-card wide"><span class="card-kicker">Bad-week fallback</span><h2>Avoid all-or-nothing thinking.</h2><ul><li>Skip or shorten football, padel, or fallback cardio first.</li><li>If necessary, reduce gym to Leg Press + Chest Press + Seated Cable Row.</li><li>Use Morning Activation when helpful, but do not treat a missed mobility circuit as program failure.</li><li>Week 8 is a review checkpoint, not the program's expiry date. If progress and recovery are good, change nothing.</li></ul></article>
    </section>`);
  bindRecoveryTools();
}
...
function renderHygiene(){
  ...
  ${training?`<section class="module-card accent-card"><div class="module-card-head"><div><small>AFTER SWEATING</small><h2>${"Post-workout"}</h2></div><span>${complete("post")?"✓":""}</span></div>${checklist(g.postWorkout,"post",b)}</section>`:""}
  ...
  bindDaily("hygiene",renderHygiene);document.querySelector("[data-save-daily]").onclick=()=>{queueHealth("hygiene",{date:isoDay(),morningComplete:complete("morning"),eveningComplete:complete("evening"),postWorkoutComplete:training?complete("post"):false,hairRoutineComplete:complete("hair"),spf:Boolean(b.checked["morning-1"]),floss:Boolean(b.checked["evening-1"]),beardOil:Boolean(b.checked["morning-3"]||b.checked["evening-6"]),showerWithin30m:Boolean(b.checked["post-0"]),completion:percent,notes:b.notes||""});state.syncState="idle";renderHygiene();};
