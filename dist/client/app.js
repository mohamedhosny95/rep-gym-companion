...
const sessions = {
  ...
  football: {
    ...
    description: "Football already gives strong cardio stimulus, so there's no separate treadmill block today — just warm up before you play and cool down after. Hamstrings and groin get priority; they're the most common football strain sites. Ends ~8:49 PM, ~71 min before a 10:00 PM bedtime — enough for a shower plus foam roller and massage gun.",
    exercises: [
...
function renderRecovery() {
  ...
  app.innerHTML = REP_SAFE_DOM.sanitize(`<section class="recovery-head"><p class="eyebrow">Recovery system</p><h1>Adaptation happens here.</h1><p>Use the basics daily. Check in weekly. Pain is information, not a challenge.</p></section>${recoveryDecisionCard()}
    <section class="recovery-grid">
      ...
      <article class="recovery-card"><span class="card-kicker">Every day</span><h2>Daily basics</h2><ul><li><strong>Sleep:</strong> 7 hours minimum. For 5:00 AM wake, aim for 10:00 PM bedtime.</li><li><strong>Hydration:</strong> At wake-up and through the morning, especially in Cairo heat.</li><li><strong>Breakfast:</strong> Protein + carbs right after the AM session.</li></ul></article>
      <article class="recovery-card"><span class="card-kicker">Sun · Mon · Tue · Wed · Thu</span><h2>After lifting, football, or padel</h2><ul><li>Foam roll lower body + back in the evening, ~8 min.</li><li>Massage gun before sleep, targeted, ~6–8 min.</li><li>Skip routine icing; use ice only for actual joint pain.</li><li>Wednesday (football) now has room too — training ends ~8:49 PM, ~71 min before a 10:00 PM bedtime comfortably covers shower plus both tools.</li></ul></article>
