const CACHE = "rep-companion-v44";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=44", "./health-data.js?v=44", "./i18n.js", "./app.js?v=44", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
