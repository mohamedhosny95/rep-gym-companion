const CACHE = "rep-companion-v51";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=51", "./health-data.js?v=51", "./i18n.js", "./app.js?v=51", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
