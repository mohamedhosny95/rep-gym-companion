const CACHE = "rep-companion-v49";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=49", "./health-data.js?v=49", "./i18n.js", "./app.js?v=49", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
