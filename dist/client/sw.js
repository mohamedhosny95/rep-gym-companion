const CACHE = "rep-companion-v53";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=53", "./health-data.js?v=53", "./i18n.js", "./app.js?v=53", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
