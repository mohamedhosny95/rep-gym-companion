const CACHE = "rep-companion-v40";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=40", "./health-data.js?v=40", "./i18n.js", "./app.js?v=40", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
