const CACHE = "rep-companion-v46";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=46", "./health-data.js?v=46", "./i18n.js", "./app.js?v=46", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
