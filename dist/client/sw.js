const CACHE = "rep-companion-v42";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=42", "./health-data.js?v=42", "./i18n.js", "./app.js?v=42", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
