const CACHE = "rep-companion-v41";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=41", "./health-data.js?v=41", "./i18n.js", "./app.js?v=41", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
