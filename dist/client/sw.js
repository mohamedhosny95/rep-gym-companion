const CACHE = "rep-companion-v48";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=48", "./health-data.js?v=48", "./i18n.js", "./app.js?v=48", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
