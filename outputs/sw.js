const CACHE = "rep-companion-v38";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=38", "./health-data.js?v=38", "./i18n.js", "./app.js?v=38", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
