const CACHE = "rep-companion-v60";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=60", "./auth.js?v=60", "./health-data.js?v=60", "./i18n.js", "./features.js?v=60", "./qrcode.js?v=60", "./health-engine.js?v=60", "./app.js?v=60", "./enhancements.js?v=60", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
