const CACHE = "rep-companion-v39";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=39", "./health-data.js?v=39", "./i18n.js", "./app.js?v=39", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
