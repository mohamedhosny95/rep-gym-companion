const CACHE = "rep-companion-v47";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=47", "./health-data.js?v=47", "./i18n.js", "./app.js?v=47", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
