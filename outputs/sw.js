const CACHE = "rep-companion-v54";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=54", "./health-data.js?v=54", "./i18n.js", "./app.js?v=54", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
