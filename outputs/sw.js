const CACHE = "rep-companion-v57";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=57", "./health-data.js?v=57", "./i18n.js", "./features.js?v=57", "./qrcode.js?v=57", "./app.js?v=57", "./enhancements.js?v=57", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
