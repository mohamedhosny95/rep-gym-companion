const CACHE = "rep-companion-v52";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=52", "./health-data.js?v=52", "./i18n.js", "./app.js?v=52", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
