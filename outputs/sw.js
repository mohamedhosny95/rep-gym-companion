const CACHE = "rep-companion-v50";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=50", "./health-data.js?v=50", "./i18n.js", "./app.js?v=50", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
