/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/server/worker-configuration.d.ts` (hash: 47cf26c5d9cef87d9e88a045e5efca74)
...
interface __BaseEnv_Env {
	...
	PAIRING_COORDINATOR: DurableObjectNamespace<import("./index").PairingCoordinator>;
	DEVICE_COORDINATOR: DurableObjectNamespace<import("./index").DeviceCoordinator>;
	DEVICE_REGISTRY: DurableObjectNamespace<import("./index").DeviceRegistry>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "PairingCoordinator" | "DeviceCoordinator" | "DeviceRegistry";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "REP_SYNC_KEY" | "NOTION_TOKEN" | "NOTION_DATA_SOURCE_ID" | "NOTION_RECOVERY_DATA_SOURCE_ID" | "NOTION_NUTRITION_DATA_SOURCE_ID" | "NOTION_HYGIENE_DATA_SOURCE_ID" | "NOTION_HABIT_DATA_SOURCE_ID" | "NOTION_FOOD_DATA_SOURCE_ID" | "CANONICAL_ORIGIN" | "VITALS_IMPORT_KEY">> {}
}
