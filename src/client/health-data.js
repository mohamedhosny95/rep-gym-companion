// Generated by scripts/generate-health-data.mjs from data/health-plan.json.
// DO NOT EDIT DIRECTLY. Run "npm run sync" to regenerate.
// Canonical source: data/health-plan.json
...
window.REP_HEALTH_GUIDE = Object.freeze({
  ...
  provenance: {
    canonicalPath: "data/health-plan.json",
    sha256: "12e154499349a171df48d09bc11cb2b4c973b9655a479b0a9a27c27c87b42fb4",
    sourceDocuments: [
      { fileName: "Training-Recovery-Guide.pdf", role: "training", contentSha256: null, status: "not_recorded_during_original_import" },
      { fileName: "hygiene-routine-daily.pdf", role: "hygiene", contentSha256: null, status: "not_recorded_during_original_import" },
      { fileName: "Mohamed_Nutrition_Plan.pdf", role: "nutrition", contentSha256: null, status: "not_recorded_during_original_import" },
      { fileName: "Master-Health-Plan.md", role: "master", contentSha256: null, status: "not_recorded_during_original_import" },
      { fileName: "exercises.json", role: "training structure", contentSha256: null, status: "not_recorded_during_original_import" }
    ]
  },
  sources: {
  ...
  hygiene: {
    ...
    afterWork: [
      "Change into clean gym or sport clothes when training",
      "Use deodorant again only if needed"
    ],
    postWorkout: [
