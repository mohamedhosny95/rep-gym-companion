...
const sessions = {
  ...
  football: {
    name: "Football Warm-up & Cooldown", short: "FB", meta: "Monday · Warm-up 10 min (hard cap) · Cooldown 8–10 min", icon: "flame", accent: "#ff5f6d",
    description: "Football already gives strong cardio stimulus, so there's no separate treadmill block today — just warm up before you play and cool down after. The warm-up is a hard 10-minute ceiling matching real pre-game time; the cooldown isn't time-pressured. Hamstrings and groin get priority; they're the most common football strain sites.",
    exercises: [
      ex("Football Warm-up Jog", "2 min", "General", 0, "general", "walk", "Open space to jog, or the pitch itself.", "Jog at an easy, conversational pace.", "Should feel effortless — just raising core temperature.", "Starting fast."),
      ex("Football Dynamic Stretches", "3 min", "Leg swings · Walking lunges · High knees · Butt kicks", 0, "dynamic", "march", "Open space, roughly 20m.", "Leg swings front/back and side/side 10 each leg, walking lunges 10 steps, then high knees and butt kicks 20m each.", "Controlled range of motion, not maximal stretch.", "Static holding — these are moving stretches."),
      ex("Lateral Shuffles & Carioca", "2 min", "2 × 20m each", 0, "activation", "walk", "Open space, roughly 20m.", "Lateral shuffles 2×20m, then carioca (crossover steps) 2×20m.", "Stay low, quick feet.", "Crossing feet awkwardly — keep it controlled."),
      ex("Football Build-up Strides", "3 min", "60% → 90% speed, 3–4 reps", 0, "build-up", "walk", "Open space, 20–30m.", "3–4 short accelerations, building from 60% to 90% of top speed, full recovery walk-back between.", "Gradual build each rep.", "Going 100% — this is a primer, not a sprint test."),
      ex("Football Cooldown Jog", "3–5 min", "Light jog / walk", 0, "general", "walk", "Open space to walk or jog easily.", "Bring the heart rate down gradually after the game.", "Let heart rate come down gradually.", "Stopping abruptly right after playing."),
      ex("Football Static Stretches", "5 stretches", "30 sec / side each", 0, "static", "stretch", "Open floor, right after the game.", "Hamstrings · Quads · Hip flexors · Calves · Groin/adductors.", "Hamstrings and groin get priority — the most common football strain sites from sprinting and cutting.", "Bouncing; skipping groin/adductors specifically.", 5)
    ]
  },
  padel: {
    name: "Padel Warm-up & Cooldown", short: "PDL", meta: "Wednesday · Warm-up 8 min · Cooldown 5–6 min", icon: "heartbeat", accent: "#ffb84d",
    description: "Padel already gives strong cardio stimulus, so there's no separate treadmill block today — just warm up before you play and cool down after. The 8-minute warm-up comfortably fits a 10-minute budget; the cooldown isn't time-pressured. Shoulder and forearm work matter more here than the legs; repeated overhead swings and gripping are padel's real fatigue point.",
    exercises: [
      ex("Padel Warm-up Jog", "2 min", "General", 0, "general", "walk", "On court, or open space nearby.", "Jog easily or move around the court.", "Just raising core temperature.", "Standing still before starting."),
      ex("Padel Dynamic Stretches", "2 min", "Leg swings · Lunges · Arm circles", 0, "dynamic", "march", "Open space or the court.", "Leg swings, walking lunges with a torso twist, then arm circles in both directions.", "Controlled range of motion.", "Static holding."),
      ex("Padel Shoulder Prep", "2 min", "Band or bodyweight · Rotations", 0, "activation", "stretch", "Standing, band optional.", "Shoulder rotations in both directions, with a band or just bodyweight.", "Smashes load the shoulder hard — this step matters more than it looks.", "Skipping this even when short on time."),
      ex("Padel Sport-Specific Warm-up", "2 min", "Shadow swings · Light rally", 0, "build-up", "walk", "Racket in hand, on court.", "Shadow swings with no ball, then light rallying to warm up timing.", "Build up pace gradually.", "Full-power shots before the ball feels warmed up."),
      ex("Padel Cooldown Walk", "2 min", "Light walk", 0, "general", "walk", "On or off court.", "Walk easily to bring the heart rate down.", "Let heart rate settle.", "Sitting down immediately after hard rallies."),
      ex("Padel Static Stretches", "4 stretches", "20–30 sec each", 0, "static", "stretch", "Open floor, right after the game.", "Shoulders/rotator cuff · Forearm/wrist · Hip flexors · Calves.", "Shoulder and forearm stretches matter more here than the legs — repeated overhead and gripping motion is padel's real fatigue point.", "Skipping the forearm/wrist stretch — easy to forget, still important.", 4)
    ]
  },
  cardio: {
