...
(function(){
  const APP_SCHEMA=20,features=window.REP_FEATURES,health=window.REP_HEALTH_ENGINE,syncCenter=window.REP_SYNC_CENTER,performance=window.REP_PERFORMANCE_INSIGHTS,adaptive=window.REP_ADAPTIVE_COACH,productSuite=window.REP_PRODUCT_SUITE;
